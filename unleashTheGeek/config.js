...
// debug
config.PRINT_READLINE = false;
config.DEBUG_TIME = false;
config.DEVMSG = false;

// tuning
config.UNKNOWN_CELL_THRESHOLD = 100; // for radar -- higher is more stringent
config.DIG_POS_SCORE_CHANGE_THRESHOLD = 20;
config.ENABLE_TRAPS = false;
config.TOP_CELLS_TO_ANALYZE = 100;
...
// prettier-ignore
config.OPTIMIZED_DIAMOND_5 = [{x:-5,y:0},{x:-4,y:-1},{x:-4,y:0},{x:-4,y:1},{x:-3,y:-2},{x:-3,y:-1},{x:-3,y:0},{x:-3,y:1},{x:-3,y:2},{x:-2,y:-3},{x:-2,y:-2},{x:-2,y:-1},{x:-2,y:0},{x:-2,y:1},{x:-2,y:2},{x:-2,y:3},{x:-1,y:-4},{x:-1,y:-3},{x:-1,y:-2},{x:-1,y:-1},{x:-1,y:0},{x:-1,y:1},{x:-1,y:2},{x:-1,y:3},{x:-1,y:4},{x:0,y:-5},{x:0,y:-4},{x:0,y:-3},{x:0,y:-2},{x:0,y:-1},{x:0,y:1},{x:0,y:2},{x:0,y:3},{x:0,y:4},{x:0,y:5},{x:5,y:0},{x:4,y:-1},{x:4,y:0},{x:4,y:1},{x:3,y:-2},{x:3,y:-1},{x:3,y:0},{x:3,y:1},{x:3,y:2},{x:2,y:-3},{x:2,y:-2},{x:2,y:-1},{x:2,y:0},{x:2,y:1},{x:2,y:2},{x:2,y:3},{x:1,y:-4},{x:1,y:-3},{x:1,y:-2},{x:1,y:-1},{x:1,y:0},{x:1,y:1},{x:1,y:2},{x:1,y:3},{x:1,y:4}];
//prettier-ignore
config.OPTIMIZED_DIAMOND_4 = [{x:-4,y:0},{x:-3,y:-1},{x:-3,y:0},{x:-3,y:1},{x:-2,y:-2},{x:-2,y:-1},{x:-2,y:0},{x:-2,y:1},{x:-2,y:2},{x:-1,y:-3},{x:-1,y:-2},{x:-1,y:-1},{x:-1,y:0},{x:-1,y:1},{x:-1,y:2},{x:-1,y:3},{x:0,y:-4},{x:0,y:-3},{x:0,y:-2},{x:0,y:-1},{x:0,y:1},{x:0,y:2},{x:0,y:3},{x:0,y:4},{x:1,y:-3},{x:1,y:-2},{x:1,y:-1},{x:1,y:0},{x:1,y:1},{x:1,y:2},{x:1,y:3},{x:2,y:-2},{x:2,y:-1},{x:2,y:0},{x:2,y:1},{x:2,y:2},{x:3,y:-1},{x:3,y:0},{x:3,y:1},{x:4,y:0},];
